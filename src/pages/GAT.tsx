      ...
      <div className="container py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          <Button
            variant="outline"
            size="lg"
            className="h-32 flex flex-col items-center justify-center gap-3 text-lg hover:bg-[#1B2B2B] hover:text-white transition-all"
          ...
          <Button
            variant="outline"
            size="lg"
            className="h-32 flex flex-col items-center justify-center gap-3 text-lg opacity-50 cursor-not-allowed"
            disabled
          >
